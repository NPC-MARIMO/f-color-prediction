...
import { Play, Crown, Sparkles, Zap } from "lucide-react";
    ...
    <Box
      sx={{
        ...
        "&::before": {
          ...
          bottom: 0,
          background:
            "radial-gradient(circle at 30% 80%, rgba(212, 175, 55, 0.1) 0%, transparent 50%), radial-gradient(circle at 80% 20%, rgba(106, 13, 173, 0.1) 0%, transparent 50%)",
          pointerEvents: "none",
        },
      }}
    >
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              <Box sx={{ textAlign: "center" }}>
                <Typography variant="h4" sx={{ color: "#00C897" }}>
                  47K+
                </Typography>
            ...
            >
              <Box
                sx={{
                  ...
                  borderRadius: "50%",
                  background:
                    "conic-gradient(from 0deg, #FF4C4C, #D4AF37, #00C897, #6A0DAD, #FF4C4C)",
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                  position: "relative",
              ...
              >
                ...
                >
                  ...
                  <Typography
                    variant="body2"
                    sx={{ color: "#CCCCCC", textAlign: "center", px: 2 }}
                  >
